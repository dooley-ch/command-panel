...
Module CommandPanelGadgetUI
  ...
  Procedure.b DisableCmpPanelItem(index.i, disable.b = #True)
    ...
    _lastErrorMessage$ = "Unable to locate a CommandPanel item with the index: " + Str(index)
    ProcedureReturn #False
  EndProcedure
  ...
  Procedure.b SelectCmpPanelItem(index.i) 
    ...
    _lastErrorMessage$ = "Unable to find CommandPanel item with index: " + Str(index)
    ProcedureReturn #False
  EndProcedure
  ...
  Procedure.b ClearCommandPanelSelection(panelIndex.i)  
    ...
    _lastErrorMessage$ = "Unable to locate CommandPanel with id: " + Str(panelIndex)
    ProcedureReturn #False
  EndProcedure
EndModule
