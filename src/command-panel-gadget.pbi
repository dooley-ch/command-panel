...
DeclareModule CommandPanelGadgetUI
  ...
  Declare.b DeleteCmpPanelItem(index.i)                                     ; Deletes an item from the panel
...
Module CommandPanelGadgetUI
  ...
  ; Deletes an item from the panel
  ;
  ; Params
  ...
  ;   True if successful, otherwise false
  ;
  Procedure.b DeleteCmpPanelItem(index.i) 
    Protected itemCfg.cpItemConfigurationEx
    
    If CommandPanelData::FindCmdPanelItemRecord(index, @itemCfg)
      CommandPanelData::SetCmdPanelItemState(index, 
                                             CommandPanelData::#CP_DeletedItem) 
      _DisplayCmdPanelItems(itemCfg\PanelIndex)
